            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="collapsibleNavId">
                    <ul class="navbar-nav me-auto mt-2 mt-lg-0">
                        <li class="nav-item">
                            <a class="nav-link" href="{{route('admin.kurir')}}">Kelola Akun Kurir</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{route('admin.tracking')}}">Pengiriman</a>
                        </li>
                    </ul>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h1 class="modal-title fs-5 text-light" id="exampleModalLabel">Logout</h1>
