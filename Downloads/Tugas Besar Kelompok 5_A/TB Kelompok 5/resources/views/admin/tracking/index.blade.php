<x-admin>
    <div class="container my-5">
        <!-- Judul -->
        <h1 class="text-center mb-4 text-primary fw-bold">📦 Tracking Pengiriman</h1>
        ...
        <div class="card shadow border-primary">
            ...
            <div class="card-footer text-center">
                <a href="{{ route('admin.tracking.create') }}" class="btn btn-primary btn-lg shadow-sm d-flex align-items-center justify-content-center">
